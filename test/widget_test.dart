...
void main(){
  ...
  test("test get data message succes", (){
    expect("OK", getDataAPI.handleResponseStatusCode(200).handleFailure?.message);
  });

  test("test get data message Failed", (){
    expect("Bad Request", getDataAPI.handleResponseStatusCode(400).handleFailure?.message);
  });
